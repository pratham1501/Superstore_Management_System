<?php
include('login1.php'); //  Login Script
if(isset($_SESSION['login_user']))
{
  header("location: dhome.php"); //  To Profile Page
}
?>
...
<html lang="en">
  ...
  <body>
    <br><br><br><br><br> <h1 class="site-heading text-center text-white d-none d-lg-block">
      <center><span class="site-heading-lower" style="color: White;">Distributor Login</span></center>
      <span class="site-heading-upper text-primary mb-3"></span></h1>
      <center>
        <div class="login">
